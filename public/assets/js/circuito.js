...
$('#cantidad_ninnos2a12').on('change', function () {
    ...
    // var oferta = getOferta(fecha);
    // totalPago(oferta);
// c1onsole.log($('#cantidad_ninnos2a12').val())
})
...
function validateAll() {
    ...
    var cantA = $('#cantidad_adultos').val();
    let result = [];
    ...
    if (tipoHabitacion) {
        ...
        if (cantA === '') {
            result ['status'] = false;
            result ['message'] = '   Para el tipo de habitación seleccionada debes especificar la cantidad de adultos';
        ...
        result ['status'] = false;
        result ['message'] = '   Debe seleccionar al menos un tipo de habitación en la pestaña habitaciones';
