...
class FlexiDriveUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'fichero_listado_hoteles' => 'sometimes|mimes:doc,docx,pdf|min:1',
            'fichero_informacion_ampliada' => 'sometimes|mimes:doc,docx,pdf|min:1',
            'imagen' => 'sometimes|mimes:jpg,png,gif,jpeg|min:1',
            'tarifario_FFD'=>'sometimes|mimes:xls,xlsx|min:1',
