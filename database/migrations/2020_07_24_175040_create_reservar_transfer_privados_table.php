...
class CreateReservarTransferPrivadosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservar_transfer_privados', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reservar_transfer_privados');
    }
}
