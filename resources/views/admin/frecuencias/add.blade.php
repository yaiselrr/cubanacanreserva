        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.frecuencia.store')}}">
                            @csrf
                            <div class="row">
                                            ...
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-one-es" role="tabpanel" aria-labelledby="custom-tabs-one-es-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('frecuencia_es') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('frecuencia_es') is-invalid @enderror" value="{{ old('frecuencia') }}" name="frecuencia_es" placeholder="Frecuencia">
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('frecuencia_en') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('frecuencia_en') is-invalid @enderror" value="{{ old('frecuencia') }}" name="frecuencia_en" placeholder="Frecuencia">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('frecuencia_en')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-fr" role="tabpanel" aria-labelledby="custom-tabs-one-fr-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('frecuencia_fr') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('frecuencia_fr') is-invalid @enderror" value="{{ old('frecuencia') }}" name="frecuencia_fr" placeholder="Frecuencia">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('frecuencia_fr')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-de" role="tabpanel" aria-labelledby="custom-tabs-one-de-tab">
                                                    <div class="form-group @error('frecuencia_de') has-error @enderror">
                                                        ...
                                                        <input type="text" class="form-control @error('frecuencia_de') is-invalid @enderror" value="{{ old('frecuencia') }}" name="frecuencia_de" placeholder="Frecuencia">
                                                        <!--<span class="error-container" style="color: red"></span>-->
                                                        @error('frecuencia_de')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-it" role="tabpanel" aria-labelledby="custom-tabs-one-it-tab">
                                                    <div class="form-group @error('frecuencia_it') has-error @enderror">
                                                        ...
                                                        <input type="text" class="form-control @error('frecuencia_it') is-invalid @enderror" value="{{ old('frecuencia') }}" name="frecuencia_it" placeholder="Frecuencia">
                                                        <!--<span class="error-container" style="color: red"></span>-->
                                                        @error('frecuencia_it')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-pt" role="tabpanel" aria-labelledby="custom-tabs-one-pt-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('frecuencia_pt') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('frecuencia_pt') is-invalid @enderror" value="{{ old('frecuencia') }}" name="frecuencia_pt" placeholder="Frecuencia">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('frecuencia_pt')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
