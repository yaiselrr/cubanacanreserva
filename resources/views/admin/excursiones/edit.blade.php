            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar Excursiones</h3>
                    </div>
                    <div class="card-body">
                        <form id="form" role="form" method="post" enctype="multipart/form-data"
                              action="{{route('admin.content.excursiones.update',$excursion->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mt-3">
                                                        <output id="list">
                                                                <span>
                                                                    <img src="{{asset('/storage/'.$excursion->imagen)}}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('nombre') has-error @enderror">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               name="nombre"
                                                               value="{{ old('nombre',$excursion->nombre) }}"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group @error('modalidads_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('modalidads_id') is-invalid @enderror"
                                                            ...
                                                            @foreach($modalidades as $modalidad)
                                                                @if($excursion->modalidads_id == $modalidad->modalidads_id)
                                                                    <option value="{{$modalidad->modalidads_id}}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('duracion_id') has-error @enderror">
                                                        <label class="control-label" for="duracion_id">Duración
                                                            <small class="required" style="color: red"> *</small>
                                                        </label>
                                                        <select class="form-control select2bs4 @error('duracion_id') is-invalid @enderror"
                                                            ...
                                                            @foreach($duracion as $dura)
                                                                @if($dura->id == $excursion->duracion_id)
                                                                    <option value="{{$dura->id}}"
                                                                            selected>{{$dura->duracion}}</option>
                                                                @else
                                                    ...
                                                    <div class="form-group @error('territorio_origen_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('territorio_origen_id') is-invalid @enderror"
                                                            ...
                                                            @foreach($provincias as $provincia)
                                                                @if($provincia->id == $excursion->territorio_origen_id )
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('territorio_destino_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('territorio_destino_id') is-invalid @enderror"
                                                            ...
                                                            <option value="">--Seleccionar--</option>
                                                            @foreach($provincias as $provincia)
                                                                @if($provincia->id == $excursion->territorio_destino_id )
                                                                    <option value="{{$provincia->id}}"
                                                                            selected>{{$provincia->provincia}}</option>
                                                                @else
                                                                    <option value="{{$provincia->id}}">{{$provincia->provincia}}</option>
                                                    ...
                                                    <div class="form-group @error('frecuencia_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('frecuencia_id') is-invalid @enderror"
                                                            ...
                                                            @foreach($frecuencia as $frec)
                                                                @if($excursion->frecuencia_id == $frec->frecuencias_id)
                                                                    <option value="{{$frec->frecuencias_id}}"
                                                                            selected>{{$frec->frecuencia}}</option>
                                                                @else
                                                    ...
                                                    <div class="form-group @error('paxminimo') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="paxminimo"
                                                                   ...
                                                                   value="{{ old('paxminimo',$excursion->paxminimo) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label" for="ofertaespecial">Oferta
                                                            Especial</label>
                                                        <select class="form-control select2bs4 @error('ofertaespecial') is-invalid @enderror"
                                                                name="oferta_especial">
                                                            <option value="">--Seleccionar--</option>
                                                            @foreach($ofertaespeciales as $ofertaespeciale)
                                                                @if($ofertaespeciale['value'] == $excursion->oferta_especial)
                                                    ...
                                                    <div class="form-group @error('estado') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('estado') is-invalid @enderror"
                                                            ...
                                                            @foreach($estados as $estado)
                                                                @if($estado['value'] == $excursion->estado)
                                                    ...
                                                    <div class="form-group @error('dias_antelacion_reserva_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('dias_antelacion_reserva_id') is-invalid @enderror"
                                                            ...
                                                            @foreach($diasantelacionreservas as $diasantelacion)
                                                                @if($excursion->dias_antelacion_reserva_id == $diasantelacion->id)
                                                                    <option value="{{$diasantelacion->id}}"
                                                                            selected>{{$diasantelacion->dias}}</option>
                                                                @else
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('capacidad') has-error @enderror">
                                                        ...
                                                        <input type="text" name="capacidad"
                                                               ...
                                                               value="{{ old('capacidad',$excursion->capacidad) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('fecha_inicio') has-error @enderror">
                                                        ...
                                                        <input type="date" name="fecha_inicio"
                                                               ...
                                                               id="fecha_inicio"
                                                               value="{{ old('fecha_inicio',$excursion->fecha_inicio) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('fecha_fin') has-error @enderror">
                                                        ...
                                                        <input type="date" name="fecha_fin"
                                                               ...
                                                               id="fecha_fin"
                                                               value="{{ old('fecha_fin',$excursion->fecha_fin) }}"
                                                    ...
                                                    <div class="form-group @error('idioma_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control duallistbox @error('idioma_id') is-invalid @enderror"
                                                            ...
                                                            @foreach($idiomas as $idioma)
                                                                ...
                                                                @php
                                                                    $cont = false;
                                                                    $data = explode(',',$excursion->idioma_id);
                                                                @endphp
                                                    ...
                                                    <div class="form-group @error('dias_semana_ids') has-error @enderror">
                                                        ...
                                                        <select class="form-control duallistbox @error('dias_semana_ids') is-invalid @enderror"
                                                            ...
                                                            @foreach($diassemanas as $diassemana)
                                                                ...
                                                                @php
                                                                    $cont = false;
                                                                    $data = explode(',',$excursion->dias_semana_ids);
                                                                @endphp
                                                                @foreach($data as $item)
                                                                    @if($diassemana->dias_semanas_id == $item)
                                                                        @php
                                                                            $cont = true;
                                                                        @endphp
                                                                    @endif
                                                                @endforeach
                                                                @if($cont == true)
                                                                    <option value="{{$diassemana->dias_semanas_id}}"
                                                                            selected>{{$diassemana->diassemana}}</option>
                                                                @else
                                                                    <option value="{{$diassemana->dias_semanas_id}}">{{$diassemana->diassemana}}</option>
                                                                @endif
                                                                }
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" type="radio"
                                                           ...
                                                           @if(old('excursion_auto_clasico',$excursion->excursion_auto_clasico)==1
                                                     || old('excursion_auto_clasico',$excursion->auto_clasico)==='on')
                                                           checked @endif>
                                                    ...
                                                    <div class="form-group @error('precio_pax_auto') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_pax_auto"
                                                                   ...
                                                                   value="{{ old('precio_pax_auto',$excursion->precio_pax_auto) }}"
                                                                   disabled
                                                        ...
                                                        <div class="bootstrap-timepicker">
                                                            <div class="input-group date"
                                                                ...
                                                                <input type="time"
                                                                       ...
                                                                       value="{{ old('hora_salida_auto',$excursion->hora_salida_auto) }}"
                                                                       data-target="#timepicker"/>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" type="radio"
                                                           ...
                                                           @if(old('excursion_unica',$excursion->excursion_unica)==1
                                                            || old('excursion_unica',$excursion->excursion_unica)==='on')
                                                           checked @endif>
                                                    ...
                                                    <div class="form-group @error('precio_pax_unica') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled name="precio_pax_unica"
                                                                   ...
                                                                   value="{{ old('precio_pax_unica',$excursion->precio_pax_unica) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12annos_unica') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12annos_unica',$excursion->precio_ninnos2a12annos_unica) }}"
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio"
                                                               ...
                                                               @if(old('excursion_alimentacion',$excursion->excursion_alimentacion)==1
                                                                           || old('excursion_alimentacion',$excursion->excursion_alimentacion)==='on')
                                                               checked @endif>
                                                    ...
                                                    <div class="form-group @error('precio_pax_almuerzo') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_almuerzo',$excursion->precio_pax_almuerzo) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('precio_ninnos2a12anno_almuerzo') has-error @enderror">
                                                        <label class="control-label"
                                                               for="precio_ninnos2a12anno_almuerzo">Precio x Niño de 2 a
                                                            12 años con almuerzo
                                                            <small class="required" style="color: red"> *</small>
                                                        </label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_almuerzo',$excursion->precio_ninnos2a12anno_almuerzo) }}"
                                                    ...
                                                    <div class="form-group @error('precio_pax_sin_almuerzo') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_sin_almuerzo',$excursion->precio_pax_sin_almuerzo) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_sin_almuerzo') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_sin_almuerzo',$excursion->precio_ninnos2a12anno_sin_almuerzo) }}"
                                                    ...
                                                    <div class="form-group @error('precio_pax_TI') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_TI',$excursion->precio_pax_TI) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_TI') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_TI',$excursion->precio_ninnos2a12anno_TI) }}"
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio"
                                                               ...
                                                               @if(old('excursion_habitacion',$excursion->excursion_habitacion)==1
                                                                                  || old('excursion_habitacion',$excursion->excursion_habitacion)==='on')
                                                               checked @endif>
                                                        <label for="excursion_habitacion"
                                                               class="custom-control-label">El precio de la excursión es
                                                            por habitaciones</label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group @error('precio_pax_hab_sencilla') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   class="form-control @error('precio_pax_sin_almuerzo') is-invalid @enderror"
                                                                   value="{{ old('precio_pax_hab_sencilla',$excursion->precio_pax_hab_sencilla) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_hab_sencilla') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_hab_sencilla',$excursion->precio_ninnos2a12anno_hab_sencilla) }}"
                                                    ...
                                                    <div class="form-group @error('precio_pax_hab_dobles') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_hab_dobles',$excursion->precio_pax_hab_dobles) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('precio_ninnos2a12anno_hab_dobles') has-error @enderror">
                                                        <label class="control-label"
                                                               for="precio_ninnos2a12anno_hab_dobles">Precio x Pax
                                                            habitación doble niños 2 a 12 años:
                                                            <small class="required" style="color: red"> *</small>
                                                        </label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_hab_dobles',$excursion->precio_ninnos2a12anno_hab_dobles) }}"
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio"
                                                               ...
                                                               @if(old('excursion_pinar_vinnales',$excursion->excursion_pinar_vinnales)==1
                                                                                  || old('excursion_pinar_vinnales',$excursion->excursion_pinar_vinnales)==='on')
                                                               checked @endif>
                                                    ...
                                                    <div class="form-group @error('precio_pax_Pinar') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_Pinar',$excursion->precio_pax_Pinar) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_Pinar') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_Pinar',$excursion->precio_ninnos2a12anno_Pinar) }}"
                                                    ...
                                                    <div class="form-group @error('precio_pax_Vinnales') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_Vinnales',$excursion->precio_pax_Vinnales) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_Vinnales') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_Vinnales',$excursion->precio_ninnos2a12anno_Vinnales) }}"
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio"
                                                               ...
                                                               @if(old('excursion_cicloturismo',$excursion->excursion_cicloturismo)==1
                                                                                         || old('excursion_cicloturismo',$excursion->excursion_cicloturismo)==='on')
                                                               checked @endif>
                                                        <label for="excursion_clicloturismo"
                                                    ...
                                                    <div class="form-group @error('precio_pax_con_canopy') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_con_canopy',$excursion->precio_pax_con_canopy) }}"
                                                    ...
                                                    <div class="form-group @error('precio_pax_sin_canopy') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_sin_canopy',$excursion->precio_pax_sin_canopy) }}"
                                                                   placeholder="Precio x Pax sin Canopy">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">.00</span>
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio"
                                                               ...
                                                               @if(old('excursion_delfines',$excursion->excursion_delfines)==1
                                                                                                || old('excursion_delfines',$excursion->excursion_delfines)==='on')
                                                               checked @endif>
                                                    ...
                                                    <div class="form-group @error('precio_pax_banno_delfines') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_banno_delfines',$excursion->precio_pax_banno_delfines) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_banno_delfines') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_banno_delfines',$excursion->precio_ninnos2a12anno_banno_delfines) }}"
                                                    ...
                                                    <div class="form-group @error('precio_pax_show_delfines') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_pax_show_delfines',$excursion->precio_pax_show_delfines) }}"
                                                    ...
                                                    <div class="form-group @error('precio_ninnos2a12anno_show_delfines') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled
                                                                   ...
                                                                   value="{{ old('precio_ninnos2a12anno_show_delfines',$excursion->precio_ninnos2a12anno_show_delfines) }}"
    ...
    <script>
        $(document).ready(function () {
                @if(old('excursion_unica',$excursion->excursion_unica)==1
                         || old('excursion_unica',$excursion->excursion_unica)==='on')
            {
                document.getElementById('excursion_unica').checked = true;
                document.getElementById('precio_pax_unica').disabled = "";
                document.getElementById('precio_ninnos2a12annos_unica').disabled = "";
            }
                @endif

                @if(old('excursion_auto_clasico',$excursion->excursion_auto_clasico)==1
                        || old('excursion_auto_clasico',$excursion->excursion_auto_clasico)==='on')
            {
                document.getElementById('excursion_auto_clasico').checked = 1;
                document.getElementById('precio_pax_auto').disabled = "";
            }
                @endif
                @if(old('excursion_alimentacion',$excursion->excursion_alimentacion)==1
                        || old('excursion_alimentacion',$excursion->excursion_alimentacion)==='on')
            {
                document.getElementById('excursion_alimentacion').checked = 1;
                document.getElementById('precio_pax_almuerzo').disabled = "";
                document.getElementById('precio_ninnos2a12anno_almuerzo').disabled = "";
                document.getElementById('precio_pax_sin_almuerzo').disabled = "";
                document.getElementById('precio_ninnos2a12anno_sin_almuerzo').disabled = "";
                document.getElementById('precio_pax_TI').disabled = "";
                document.getElementById('precio_ninnos2a12anno_TI').disabled = "";
            }
                @endif
                @if(old('excursion_habitacion',$excursion->excursion_habitacion)==1
                            || old('excursion_habitacion',$excursion->excursion_habitacion)==='on')
            {
                document.getElementById('excursion_habitacion').checked = 1;
                document.getElementById('precio_pax_hab_sencilla').disabled = "";
                document.getElementById('precio_ninnos2a12anno_hab_sencilla').disabled = "";
                document.getElementById('precio_pax_hab_dobles').disabled = "";
                document.getElementById('precio_ninnos2a12anno_hab_dobles').disabled = "";
            }
                ...
                @if(old('excursion_pinar_vinnales',$excursion->excursion_pinar_vinnales)==1
                              || old('excursion_pinar_vinnales',$excursion->excursion_pinar_vinnales)==='on')
            {
                document.getElementById('excursion_pinar_vinnales').checked = 1;
                document.getElementById('precio_pax_Pinar').disabled = "";
                document.getElementById('precio_ninnos2a12anno_Pinar').disabled = "";
                document.getElementById('precio_pax_Vinnales').disabled = "";
                document.getElementById('precio_ninnos2a12anno_Vinnales').disabled = "";
            }
                ...
                @if(old('excursion_cicloturismo',$excursion->excursion_cicloturismo)==1
                              || old('excursion_cicloturismo',$excursion->excursion_cicloturismo)==='on')
            {
                document.getElementById('excursion_cicloturismo').checked = 1;
                document.getElementById('precio_pax_con_canopy').disabled = "";
                document.getElementById('precio_pax_sin_canopy').disabled = "";
            }
                ...
                @if(old('excursion_delfines',$excursion->excursion_delfines)==1
                                || old('excursion_delfines',$excursion->excursion_delfines)==='on')
            {
                document.getElementById('excursion_delfines').checked = 1;
                document.getElementById('precio_pax_banno_delfines').disabled = "";
                document.getElementById('precio_ninnos2a12anno_banno_delfines').disabled = "";
                document.getElementById('precio_pax_show_delfines').disabled = "";
                document.getElementById('precio_ninnos2a12anno_show_delfines').disabled = "";
            }
