            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar Facilidad</h3>
                    </div>
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.facilidades.update',$facilidad->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-one-es" role="tabpanel" aria-labelledby="custom-tabs-one-es-tab">
                                                    <div class="form-group @error('facilidad_es') has-error @enderror">
                                                        ...
                                                        <input type="text" class="form-control @error('facilidad_es') is-invalid @enderror" value="{{ old('facilidad',$facilidadtraslation['facilidad_es']) }}" name="facilidad_es" placeholder="Facilidad">
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('facilidad_en') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('facilidad_en') is-invalid @enderror" value="{{ old('facilidad',$facilidadtraslation['facilidad_en']) }}" name="facilidad_en" placeholder="Facilidad">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('facilidad_en')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-fr" role="tabpanel" aria-labelledby="custom-tabs-one-fr-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('facilidad_fr') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('facilidad_fr') is-invalid @enderror" value="{{ old('facilidad',$facilidadtraslation['facilidad_fr']) }}" name="facilidad_fr" placeholder="Facilidad">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('facilidad_fr')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-de" role="tabpanel" aria-labelledby="custom-tabs-one-de-tab">
                                                    <div class="form-group @error('facilidad_de') has-error @enderror">
                                                        ...
                                                        <input type="text" class="form-control @error('facilidad_de') is-invalid @enderror" value="{{ old('facilidad',$facilidadtraslation['facilidad_de']) }}" name="facilidad_de" placeholder="Facilidad">
                                                        <!--<span class="error-container" style="color: red"></span>-->
                                                        @error('facilidad_de')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-it" role="tabpanel" aria-labelledby="custom-tabs-one-it-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('facilidad_it') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('facilidad_it') is-invalid @enderror" value="{{ old('facilidad',$facilidadtraslation['facilidad_it']) }}" name="facilidad_it" placeholder="Facilidad">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('facilidad_it')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-pt" role="tabpanel" aria-labelledby="custom-tabs-one-pt-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('facilidad_pt') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('facilidad_pt') is-invalid @enderror" value="{{ old('facilidad',$facilidadtraslation['facilidad_pt']) }}" name="facilidad_pt" placeholder="Facilidad">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('facilidad_pt')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
