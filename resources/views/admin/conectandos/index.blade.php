...
@section('content')
    ...
    <section class="content-header">
        <a href="{{ route('admin.content.conectandos.create') }}"
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado de Traslado Conectando Cuba</h3>
                    ...
                    <div class="card-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @foreach($conectandos as $key => $c)
                                <tr>

                                    <th>{{ $c->ruta->ruta }}</th>
                                    <th>{{ $c->dias_antelacion_id }}</th>
                                    <td>{{ $c->created_at }}</td>
                                    <td>{{ $c->updated_at }}</td>
                                    ...
                                    <td style="width: 120px;">
                                        ...
                                        <a href="{{ route('admin.content.conectandos.edit',$c->id) }}"
                                           class="btn btn-info btn-sm"><i class="fas fa-pencil-alt">
                                            </i></a>
                                        <a href="" data-toggle="modal"
                                           data-route="{{route('admin.content.colectivos.destroy',  $c->id)}}"
