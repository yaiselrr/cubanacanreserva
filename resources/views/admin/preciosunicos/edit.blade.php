...
@section('content')
    @include('admin.cancel', ['route'=>route('admin.content.preciosunicos.index')])
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar Transfer Colectivo Precio Unico</h3>
                    </div>
                    <div class="card-body">
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <form action="{{ route('admin.content.preciosunicos.update',$transfer->id) }}" method="post"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="dias_antelacion"
                                                        ...
                                                        @endif
                                                        @if($transfer->dias_antelacion == 10)
                                                        ...
                                                        @if($transfer->dias_antelacion == 20)
                                                            <option value="0">0</option>
                                                            <option value="10">10</option>
                                                        ...
                                                        @if($transfer->dias_antelacion == 30)
                                                            <option value="0">0</option>
                                                            <option value="10">10</option>
                                                            <option value="20">20</option>
                                                        ...
                                                        @if($transfer->dias_antelacion == 50)
                                                            <option value="0">0</option>
                                                            <option value="10">10</option>
                                                            <option value="20">20</option>
                                                            <option value="30">30</option>
                                                        ...
                                                        @if($transfer->dias_antelacion == 80)
                                                            <option value="0">0</option>
                                                            <option value="10">10</option>
                                                            <option value="20">20</option>
                                                            <option value="30">30</option>
                                                        ...
                                                        @if($transfer->dias_antelacion == 100)
                                                            <option value="0">0</option>
                                                            <option value="10">10</option>
                                                            <option value="20">20</option>
                                                            <option value="30">30</option>
