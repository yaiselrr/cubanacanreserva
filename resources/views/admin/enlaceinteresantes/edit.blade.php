            ...
            <!-- general form elements -->
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar Enlaces Interesante</h3>
                    </div>
                    <div class="card-body">
                        <form id="addForm" name="addForm" role="form" method="post" enctype="multipart/form-data"
                              action="{{route('admin.content.enlace_interesantes.update',$enlace->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="custom-tabs-one-es-tab"
                                                       ...
                                                       aria-selected="true">Editar Enlace Interesante</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input id="files" type="file" name="avatar"
                                                                               accept="image/*"
                                                                    ...
                                                                    <div class="mt-3">
                                                                        <output id="list">
                                                                <span>
                                                                    <img src="{{asset('imagen/enlaceinteresante/'.$enlace->imagen)}}"
