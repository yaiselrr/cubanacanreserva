            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Crear Días de la Semana</h3>
                    </div>
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.dias-semana.store')}}">
                            @csrf
                            <div class="row">
                                            ...
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-one-es" role="tabpanel" aria-labelledby="custom-tabs-one-es-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('diassemana_es') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('diassemana_es') is-invalid @enderror" value="{{ old('diassemana') }}" name="diassemana_es" placeholder="Días de la Semana">
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('diassemana_en') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('diassemana_en') is-invalid @enderror" value="{{ old('diassemana') }}" name="diassemana_en" placeholder="Días de la Semana">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('diassemana_en')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-fr" role="tabpanel" aria-labelledby="custom-tabs-one-fr-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('diassemana_fr') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('diassemana_fr') is-invalid @enderror" value="{{ old('diassemana') }}" name="diassemana_fr" placeholder="Días de la Semana">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('diassemana_fr')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-de" role="tabpanel" aria-labelledby="custom-tabs-one-de-tab">
                                                    <div class="form-group @error('diassemana_de') has-error @enderror">
                                                        ...
                                                        <input type="text" class="form-control @error('diassemana_de') is-invalid @enderror" value="{{ old('diassemana') }}" name="diassemana_de" placeholder="Días de la Semana">
                                                        <!--<span class="error-container" style="color: red"></span>-->
                                                        @error('diassemana_de')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-it" role="tabpanel" aria-labelledby="custom-tabs-one-it-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('diassemana_it') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('diassemana_it') is-invalid @enderror" value="{{ old('diassemana') }}" name="diassemana_it" placeholder="Días de la Semana">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('diassemana_it')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-pt" role="tabpanel" aria-labelledby="custom-tabs-one-pt-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('diassemana_pt') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('diassemana_pt') is-invalid @enderror" value="{{ old('diassemana') }}" name="diassemana_pt" placeholder="Días de la Semana">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('diassemana_pt')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
