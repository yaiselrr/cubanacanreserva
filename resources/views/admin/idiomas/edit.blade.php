        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.idiomas.update',$idioma->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-12">
                                    <div class="box-body">
                                        <div class="form-group @error('idioma') has-error @enderror">
                                            <label class="control-label" for="idioma">Idioma<small class="required" style="color: red"> *</small></label>
                                            <input type="text" class="form-control @error('idioma') is-invalid @enderror" value="{{ old('idioma',$idioma->idioma) }}" name="idioma" placeholder="Idioma">
