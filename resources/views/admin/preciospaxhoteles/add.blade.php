            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Crear Precios Pax por temporada del Hotel</h3>
                    </div>
                    <div class="card-body">
                        <form id="form" role="form" method="post" enctype="multipart/form-data"
                              action="{{route('admin.content.precios-pax-hotel.store')}}">
                            @csrf
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-12">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group @error('hotel_id') has-error @enderror">
                                                    ...
                                                    <select class="form-control select2bs4 @error('hotel_id') is-invalid @enderror"
                                                            id="hotel_id" name="hotel_id">
                                                        <option value="">--Seleccionar--</option>
                                                        @foreach($hoteles as $hotele)
                                                            <option value="{{$hotele->id}}">{{$hotele->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group @error('cantidad_hab_sencillas') has-error @enderror">
                                                    ...
                                                    <input type="text" name="cantidad_hab_sencillas"
                                                           ...
                                                           value="{{ old('cantidad_hab_sencillas') }}"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group @error('cantidad_hab_dobles') has-error @enderror">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group @error('cantidad_hab_triples') has-error @enderror">
                                                    ...
                                                    <input type="text" name="cantidad_hab_triples"
                                                           ...
                                                           value="{{ old('cantidad_hab_triples') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="checkbox">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="check1"
                                                           ...
                                                           @if(old('variante2adultos_hasta2ninnos_2a12annos')=="on")
                                                           checked @endif>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_adulto_variante2adultos') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_adulto_variante2adultos"
                                                                   id="precio_adulto_variante2adultos"
                                                                   class="form-control @error('precio_adulto_variante2adultos') is-invalid @enderror"
                                                                   value="{{ old('precio_adulto_variante2adultos') }}"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_1er_ninno_variante2adultos') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_1er_ninno_variante2adultos"
                                                                   id="precio_1er_ninno_variante2adultos"
                                                                   class="form-control @error('precio_1er_ninno_variante2adultos') is-invalid @enderror"
                                                                   value="{{ old('precio_1er_ninno_variante2adultos') }}"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_2do_ninno_variante2adultos') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_2do_ninno_variante2adultos"
                                                                   id="precio_2do_ninno_variante2adultos"
                                                                   class="form-control @error('precio_2do_ninno_variante2adultos') is-invalid @enderror"
                                                                   value="{{ old('precio_2do_ninno_variante2adultos') }}"
                                                                   disabled="disabled"
                                            ...
                                            <div class="checkbox">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="check2"
                                                           ...
                                                           @if(old('variante1adulto_hasta3ninnos_2a12annos')=="on")
                                                           checked @endif>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_adulto_variante1adulto') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_adulto_variante1adulto"
                                                                   id="precio_adulto_variante1adulto"
                                                                   class="form-control @error('precio_adulto_variante1adulto') is-invalid @enderror"
                                                                   value="{{ old('precio_adulto_variante1adulto') }}"
                                                                   disabled="disabled" placeholder="Precio adulto">
                                                            </input>
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">.00</span>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_1er_ninno_variante1adulto') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_1er_ninno_variante1adulto"
                                                                   id="precio_1er_ninno_variante1adulto"
                                                                   class="form-control @error('precio_1er_ninno_variante1adulto') is-invalid @enderror"
                                                                   value="{{ old('precio_1er_ninno_variante1adulto') }}"
                                                                   disabled="disabled" placeholder="Precio primer niño">
                                                            </input>
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            <div class="input-group-append">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_2do_ninno_variante1adulto') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_2do_ninno_variante1adulto"
                                                                   id="precio_2do_ninno_variante1adulto"
                                                                   class="form-control @error('precio_2do_ninno_variante1adulto') is-invalid @enderror"
                                                                   value="{{ old('precio_2do_ninno_variante1adulto') }}"
                                                                   disabled="disabled"
                                                                   placeholder="Precio segundo niño">
                                                            </input>
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                        ...
                                                        @error('precio_2do_ninno_variante1adulto')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_3er_ninno_variante1adulto') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="precio_3er_ninno_variante1adulto"
                                                                   id="precio_3er_ninno_variante1adulto"
                                                                   class="form-control @error('precio_3er_ninno_variante1adulto') is-invalid @enderror"
                                                                   value="{{ old('precio_3er_ninno_variante1adulto') }}"
                                            ...
                                            <div class="checkbox">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="check3"
                                                           ...
                                                           @if(old('variante2adultos_2hasta3ninnos_2a12annos')=="on")
                                                           checked @endif>
                                                    <label for="check3" class="custom-control-label">Variante 2 adultos
                                                        y de 2 a 3 niños de 2 a 12 años en otra habitación contigua</label>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_adulto_variante2adultos_2hasta3ninnos') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="{{ old('precio_adulto_variante2adultos_2hasta3ninnos') }}"
                                                                   disabled="disabled" placeholder="Precio adulto">
                                                            </input>
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            <div class="input-group-append">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_1er_ninno_variante1adultos_variante2adultos_2hasta3ninnos') has-error @enderror">
                                                        <label class="control-label"
                                                               for="precio_adulto_variante2adultos_2hasta3ninnos">Precio
                                                            primer niño
                                                            <small class="required" style="color: red"> *</small>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="{{ old('precio_1er_ninno_variante1adultos_variante2adultos_2hasta3ninnos') }}"
                                                                   disabled="disabled"
                                                                   placeholder="Precio primer niño">
                                                            </input>
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">.00</span>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group @error('precio_2do_ninno_variante1adultos_variante2adultos_2hasta3ninnos') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="{{ old('precio_2do_ninno_variante1adultos_variante2adultos_2hasta3ninnos') }}"
                                                                   disabled="disabled"
                                                                   placeholder="Precio segundo niño">
                                                            </input>
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group @error('precio_3er_ninno_variante1adultos_variante2adultos_2hasta3ninnos') has-error @enderror">
                                                    <label class="control-label"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('precio_3er_ninno_variante1adultos_variante2adultos_2hasta3ninnos') }}"
                                                               disabled="disabled"
                                                               placeholder="Precio tercer niño">
                                                        </input>
                                                        <!--<span class="error-container" style="color: red"></span>-->
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">.00</span>
                                            ...
                                            <div class="checkbox">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="check4"
                                                           ...
                                                           @if(old('variante3adultos_mismahabitacion')=="on")
                                                           checked @endif>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('precio_adulto_variante3adultos_mismahabitacion') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="{{ old('precio_adulto_variante3adultos_mismahabitacion') }}"
                                                                   disabled="disabled"
                                                ...
                                                <div class="checkbox">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input" type="checkbox" id="check5"
                                                               ...
                                                               @if(old('variante1adulto_mismahabitacion')=="on")
                                                               checked @endif>
                                                        <label for="check5" class="custom-control-label">Variante 1
                                                            adulto alojado solo en una habitación</label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('precio_adulto_variante1adulto_mismahabitacion') has-error @enderror">
                                                        <label class="control-label"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="{{ old('precio_adulto_variante1adulto_mismahabitacion') }}"
                                                                   disabled="disabled"
                                                                   placeholder="Precio adulto">
                                                            </input>
                                                            <!--<span class="error-container" style="color: red"></span>-->
