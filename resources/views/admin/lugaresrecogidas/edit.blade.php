            ...
            <div class="col-md-10">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar datos del traslado: {{ $conectando->id }}</h3>
                    </div>
                    <div class="card-body">
                        @if (count($errors) > 0)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="provincia_origen"
                                                            id="provincia_origen">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="provincia_destino"
                                                            id="provincia_destino">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="precio_pax"
                                                           id="precio_pax"
                                                           value="{{ old('precio_pax', $data['precio_pax']) }}"
