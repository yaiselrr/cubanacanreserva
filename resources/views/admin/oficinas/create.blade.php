            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Crear Oficinas Comerciales</h3>
                    </div>
                    <div class="card-body">
                        <form id="addForm" name="addForm" role="form" method="post" enctype="multipart/form-data"
                              action="{{route('admin.content.oficinas.store')}}">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="card card-dark card-tabs">
                                        <div class="card-header p-0 pt-1">
                                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="custom-tabs-one-dt-tab" data-toggle="pill" href="#custom-tabs-one-dt" role="tab" aria-controls="custom-tabs-one-dt" aria-selected="false"><img src="{{ asset('flags/de.png')}}" alt="flag" />&nbsp;&nbsp;DE</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <div class="tab-pane fade show active" id="custom-tabs-one-es"
                                                    ...
                                                    <div class="box-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control {{ $errors->has('oficina_nombre_es')?'is-invalid':'' }}" name="oficina_nombre_es"
                                                                       id="oficina_nombre_es" value="{{ old('oficina_nombre_es') }}"
                                                                       placeholder="Nombre">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="textarea form-control" name="direccion_es"
                                                                          id="direccion_es" value="{{ old('direccion_es') }}" rows="3" placeholder="Dirección"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade show active" id="custom-tabs-one-en"
                                                        ...
                                                        <div class="box-body">
                                                                <div class="form-group">
                                                                    <label>Nombre</label>
                                                                    <input type="text" class="form-control" name="oficina_nombre_en"
                                                                           id="oficina_nombre_en" value="{{ old('oficina_nombre_en') }}"
                                                                           placeholder="Nombre">
                                                            </div>
                                                                <div class="form-group">
                                                                    <label>Dirección</label>
                                                                    <textarea class="textarea form-control" name="direccion_en"
                                                                              id="direccion_en" value="{{ old('direccion_en') }}" rows="3" placeholder="Dirección"></textarea>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-fr" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade show active" id="custom-tabs-one-fr"
                                                        ...
                                                        <div class="box-body">
                                                                <div class="form-group">
                                                                    <label>Nombre</label>
                                                                    <input type="text" class="form-control" name="oficina_nombre_fr"
                                                                           id="oficina_nombre_fr" value="{{ old('oficina_nombre_fr') }}"
                                                                           placeholder="Nombre">
                                                            </div>
                                                                <div class="form-group">
                                                                    <label>Dirección</label>
                                                                    <textarea class="textarea form-control" name="direccion_fr"
                                                                              id="direccion_fr" value="{{ old('direccion_fr') }}" rows="3" placeholder="Dirección"></textarea>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-dt" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade show active" id="custom-tabs-one-dt"
                                                        ...
                                                        <div class="box-body">
                                                                <div class="form-group">
                                                                    <label>Nombre</label>
                                                                    <input type="text" class="form-control" name="oficina_nombre_dt"
                                                                           id="oficina_nombre_dt" value="{{ old('oficina_nombre_dt') }}"
                                                                           placeholder="Nombre">
                                                            </div>
                                                                <div class="form-group">
                                                                    <label>Dirección</label>
                                                                    <textarea class="textarea form-control" name="direccion_dt"
                                                                              id="direccion_dt" value="{{ old('direccion_dt') }}" rows="3" placeholder="Dirección"></textarea>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-it" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade show active" id="custom-tabs-one-it"
                                                        ...
                                                        <div class="box-body">
                                                                <div class="form-group">
                                                                    <label>Nombre</label>
                                                                    <input type="text" class="form-control" name="oficina_nombre_it"
                                                                           id="oficina_nombre_it" value="{{ old('oficina_nombre_it') }}"
                                                                           placeholder="Nombre">
                                                            </div>
                                                                <div class="form-group">
                                                                    <label>Dirección</label>
                                                                    <textarea class="textarea form-control" name="direccion_it"
                                                                              id="direccion_it" value="{{ old('direccion_it') }}" rows="3" placeholder="Dirección"></textarea>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-pt" role="tabpanel"
                                                    ...
                                                    <div class="tab-pane fade show active" id="custom-tabs-one-pt"
                                                        ...
                                                        <div class="box-body">
                                                                <div class="form-group">
                                                                    <label>Nombre</label>
                                                                    <input type="text" class="form-control" name="oficina_nombre_pt"
                                                                           id="oficina_nombre_pt" value="{{ old('oficina_nombre_pt') }}"
                                                                           placeholder="Nombre">
                                                            </div>
                                                                <div class="form-group">
                                                                    <label>Dirección</label>
                                                                    <textarea class="textarea form-control" name="direccion_pt"
                                                                              id="direccion_pt" value="{{ old('direccion_pt') }}" rows="3" placeholder="Dirección"></textarea>
                                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('telefono')?'is-invalid':'' }}" data-inputmask='"mask": "(+53) 9999-99-99"' data-mask name="telefono"
