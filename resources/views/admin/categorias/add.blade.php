        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.categorias.store')}}">
                            @csrf
                            <div class="row">
                                                ...
                                                <div class="tab-pane fade show active" id="custom-tabs-one-es" role="tabpanel" aria-labelledby="custom-tabs-one-es-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('categoria_es') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('categoria_es') is-invalid @enderror" value="{{ old('categoria') }}" name="categoria_es" placeholder="Categoría">
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('categoria_en') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('categoria_en') is-invalid @enderror" value="{{ old('categoria') }}" name="categoria_en" placeholder="Categoría">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('categoria_en')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-fr" role="tabpanel" aria-labelledby="custom-tabs-one-fr-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('categoria_fr') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('categoria_fr') is-invalid @enderror" value="{{ old('categoria') }}" name="categoria_fr" placeholder="Categoría">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('categoria_fr')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-de" role="tabpanel" aria-labelledby="custom-tabs-one-de-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('categoria_de') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('categoria_de') is-invalid @enderror" value="{{ old('categoria') }}" name="categoria_de" placeholder="Categoría">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('categoria_de')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-it" role="tabpanel" aria-labelledby="custom-tabs-one-it-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('categoria_it') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('categoria_it') is-invalid @enderror" value="{{ old('categoria') }}" name="categoria_it" placeholder="Categoría">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('categoria_it')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-pt" role="tabpanel" aria-labelledby="custom-tabs-one-pt-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('categoria_pt') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('categoria_pt') is-invalid @enderror" value="{{ old('categoria') }}" name="categoria_pt" placeholder="Categoría">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('categoria_pt')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
