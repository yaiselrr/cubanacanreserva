                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form id="addForm" name="addForm" role="form" method="post" enctype="multipart/form-data"
                              action="{{route('admin.content.eventos.store')}}">
                            @csrf
                            <div class="row">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-10">
                                                                <!-- textarea -->
                                                                <div class="form-group">
                                                                    <label>Resumen a Mostrar:*</label>
                                                                    <textarea class="form-control" name="resumen_es"
                                                                              id="resumen_es"
                                                                              value="{{ old('resumen_es') }}"
                                                                              rows="3"
                                                                              placeholder="Resumen a Mostrar"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" class="form-control" name="convocatorias"
                                                                           id="convocatorias"
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" class="form-control" name="programas" id="programas"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2bs4"
                                                                            style="width: 100%;" id="provincia_id"
                                                                            name="provincia_id">
                                                                        <option value="">--Seleccionar--</option>
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2bs4"
                                                                        ...
                                                                        <option value="">--Seleccionar--</option>
                                                                        @foreach($servicio_transporte as $serviciotransporte)
                                                                            <option value="{{$serviciotransporte['value']}}">{{$serviciotransporte['servico_transporte']}}</option>
                                                                        @endforeach
                                                                    </select>
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Resumen a Mostrar:*</label>
                                                                        <textarea class="form-control" name="resumen_en"
                                                                                  id="resumen_en"
                                                                                  value="{{ old('resumen_en') }}"
                                                                                  rows="3"
                                                                                  placeholder="Resumen a Mostrar"></textarea>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Resumen a Mostrar:*</label>
                                                                        <textarea class="form-control" name="resumen_fr"
                                                                                  id="resumen_fr"
                                                                                  value="{{ old('resumen_fr') }}"
                                                                                  rows="3"
                                                                                  placeholder="Resumen a Mostrar"></textarea>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Resumen a Mostrar:*</label>
                                                                        <textarea class="form-control" name="resumen_it"
                                                                                  id="resumen_it"
                                                                                  value="{{ old('resumen_it') }}"
                                                                                  rows="3"
                                                                                  placeholder="Resumen a Mostrar"></textarea>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Resumen a Mostrar:*</label>
                                                                        <textarea class="form-control" name="resumen_pt"
                                                                                  id="resumen_pt"
                                                                                  value="{{ old('resumen_pt') }}"
                                                                                  rows="3"
                                                                                  placeholder="Resumen a Mostrar"></textarea>
                                                                    </div>
                                                                </div>
