            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Crear Quienes Somos</h3>
                    </div>
                    <div class="card-body">
                        <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.content.quienes-somos.store')}}">
                            @csrf
                            <div class="row">
                                                ...
                                                <div class="tab-pane fade show active" id="custom-tabs-one-es" role="tabpanel" aria-labelledby="custom-tabs-one-es-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('titulo_es') has-error @enderror">
                                                            ...
                                                            <input type="text" class="form-control @error('titulo_es') is-invalid @enderror" value="{{ old('titulo') }}" name="titulo_es" placeholder="Título">
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('titulo_en') has-error @enderror">
                                                            <label for="titulo">Título{{--<small class="required" style="color: red"> *</small>--}}</label>
                                                            <input type="text" class="form-control @error('titulo_en') is-invalid @enderror" value="{{ old('titulo') }}" name="titulo_en"
                                                                   placeholder="Título">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('titulo_en')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-fr" role="tabpanel" aria-labelledby="custom-tabs-one-fr-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('titulo_fr') has-error @enderror">
                                                            <label for="titulo">Título{{--<small class="required" style="color: red"> *</small>--}}</label>
                                                            <input type="text" class="form-control @error('titulo_fr') is-invalid @enderror" value="{{ old('titulo') }}" name="titulo_fr"
                                                                   placeholder="Título">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('titulo_fr')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-de" role="tabpanel" aria-labelledby="custom-tabs-one-de-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('titulo_de') has-error @enderror">
                                                            <label for="titulo">Título{{--<small class="required" style="color: red"> *</small>--}}</label>
                                                            <input type="text" class="form-control @error('titulo_de') is-invalid @enderror" value="{{ old('titulo') }}" name="titulo_de"
                                                                   placeholder="Título">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('titulo_de')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        ...
                                                        <div class="form-group @error('descripcion_de') has-error @enderror">
                                                            <label for="descripcion">Descripción{{--<small class="required" style="color: red"> *</small>--}}</label>
                                                            <textarea name="descripcion_de" class="textarea form-control @error('descripcion') is-invalid @enderror" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"
                                                                      placeholder="Descripción">{{ old('direccion') }}</textarea>
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-it" role="tabpanel" aria-labelledby="custom-tabs-one-it-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('titulo_it') has-error @enderror">
                                                            <label for="titulo">Título{{--<small class="required" style="color: red"> *</small>--}}</label>
                                                            <input type="text" class="form-control @error('titulo_it') is-invalid @enderror" value="{{ old('titulo') }}" name="titulo_it"
                                                                   placeholder="Título">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('titulo_it')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-pt" role="tabpanel" aria-labelledby="custom-tabs-one-pt-tab">
                                                    <div class="box-body">
                                                        <div class="form-group @error('titulo_pt') has-error @enderror">
                                                            <label for="titulo">Título{{--<small class="required" style="color: red"> *</small>--}}</label>
                                                            <input type="text" class="form-control @error('titulo_pt') is-invalid @enderror" value="{{ old('titulo') }}" name="titulo_pt"
                                                                   placeholder="Título">
                                                            <!--<span class="error-container" style="color: red"></span>-->
                                                            @error('titulo_pt')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('imagen') has-error @enderror">
                                                        ...
                                                        <div class="input-group">
                                                                <input id="files" type="file" accept="image/*" name="imagen" id="imagen" class="custom-file-input @error('imagen') is-invalid @enderror">
