            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Crear Información de Contacto</h3>
                    </div>
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.content.contactos.store')}}">
                            @csrf
                            <div class="row">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group @error('direccion_es') has-error @enderror">
                                                            ...
                                                            <input type="text" name="direccion_es" class="form-control @error('direccion_es') is-invalid @enderror"
                                                                   placeholder="Dirección">{{ old('direccion') }}</input>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group @error('telefono') has-error @enderror">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control @error('telefono') is-invalid @enderror" data-inputmask='"mask": "(+53) 9999-9999"' data-mask value="{{ old('telefono') }}" name="telefono" placeholder="Teléfono">
                                                        @error('telefono')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                ...
                rules: {
                   /*telefono: {
                        ...
                        remote:{
                            ...
                            data: {
                                value: function () {
                                    return $('#addform :input[name="telefono"]').val();
                                }
                                , id: function () {
                                    return $('#addform :input[name="telefono"]').data('id')
                                },
                                model: function () {
                                    return $('#addform :input[name="telefono"]').data('model')
                                }
                            }
                        }
                    ...
                    email: {
                        ...
                        remote:{
                            ...
                            data: {
                                ...
                                , id: function () {
                                    return $('#addform :input[name="email"]').data('id')
                                },
                                model: function () {
                                    return $('#addform :input[name="email"]').data('model')
                                }
                            }
                        }
                    },*/
