...
@section('content')
    @include('admin.cancel', ['route'=>route('admin.content.enlace_reds.index')])
    <!-- Main content -->
            ...
            <!-- general form elements -->
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar Enlaces a Redes Sociales</h3>
                    </div>
                    <div class="card-body">
                        <form id="addForm" name="addForm" role="form" method="post" enctype="multipart/form-data"
                              action="{{route('admin.content.enlace_reds.update',$enlace->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="custom-tabs-one-es-tab"
                                                       ...
                                                       aria-selected="true">Enlace Red Social</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="mt-3">
                                                                        <output id="list">
                                                                <span>
                                                                    <img src="{{asset('imagen/enlacered/'.$enlace->imagen)}}"
