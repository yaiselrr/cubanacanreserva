            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Editar Plan de Alojamiento</h3>
                    </div>
                    <div class="card-body">
                        <form id="addform" role="form" name="addform" method="post" enctype="multipart/form-data" action="{{route('admin.nomenclator.plan-alojamiento.update',$planalojamiento->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-12">
                                    <div class="box-body">
                                        <div class="form-group @error('planalojamiento') has-error @enderror">
                                            ...
                                            <input type="text" class="form-control @error('planalojamiento') is-invalid @enderror" value="{{ old('planalojamiento',$planalojamiento->planalojamiento) }}" name="planalojamiento" placeholder="Plan Alojamiento">
