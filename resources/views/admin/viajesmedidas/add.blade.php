        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form id="form" role="form" method="post" enctype="multipart/form-data" action="{{route('admin.content.viajes-medidas.store')}}">
                            @csrf
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group @error('provincia_id') has-error @enderror">
                                                        ...
                                                        <select class="form-control select2bs4 @error('provincia_id') is-invalid @enderror" name="provincia_id">
