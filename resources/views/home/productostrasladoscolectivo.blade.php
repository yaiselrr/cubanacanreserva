    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <p>En un ómnibus de turismo, acompañado y asistido por guías de turismo, todos los días, permite viajar
                    entre
                    hoteles ubicados en varias ciudades y polos turísticos del país. Durante el viaje se ofrece
                    información
                    general de las zonas por donde se transita y se harán breves paradas en instalaciones turísticas
                    para
                    estirar las piernas, ir al baño, merendar o almorzar según la Conexión. Conectando Cuba está
                    disponible en
                    todas las provincias donde opera la Agencia Viajes Cubanacán en sus Buróes de Turismo. Forma parte
                    del
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <form id="colectivo" name="colectivo" role="form" method="post"
                          enctype="multipart/form-data"
                          action="{{route('home.transfercolectivo.store')}}">
                        @csrf
            ...
            {{--<div class="card-footer">--}}
                {{--<div class="modal-footer">--}}
                    {{--<button type="button" class="btn btn-danger" style="float: left" id="botonp">Total a pagar: USD--}}
                    {{--</button>--}}
                    {{--<button type="button" class="btn btn-danger" style="float: right;" data-dismiss="modal">--}}
                        {{--Cancelar--}}
                    {{--</button>--}}
...
@section('jsprueba')
    <script type="text/javascript">
        ...
        $('#botonp').on('click', function (event) {
            ...
            var dataformulario = $('#colectivo').get(0);
            console.log(url);
        ...
        $('#cantidad_adultos').on('change', function () {
            ...
            $.each(inicisss, function (i, item) {
                if (item['id'] == prvincia) {
                    ...
                    var ss = item['taxi_standar_hdos_sin']
                    var sc = item['taxi_standar_hdos_con']
                    var ms = item['taxi_micro_hcuatro_sin']
                    var mc = item['taxi_micro_hcuatro_con']
                    var mics = item['transtur_micro_hocho_sin']
                    var micc = item['transtur_micro_hocho_con']
                    var minc1 = item['transtur_mini_hdoce_con']
                    var minc2 = item['transtur_mini_hveinte_con']
                    var omn1 = item['transtur_omnibus_htreinta_con']
                    var omn2 = item['transtur_omnibus_hcuarentatres_con']

                    if (parseInt(cod) == 2 && parseInt(gu) == 0) {

                        //alert(parseInt(item['taxi_standar_hdos_sin']) * parseInt(adultos));
                        var precioadulto = parseInt(item['taxi_standar_hdos_sin']) * parseInt(adultos);
                        ...
                        var precioadulto = parseInt(item['taxi_standar_hdos_con']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
                    else if (parseInt(cod) == 4 && parseInt(gu) == 0) {

                        //alert(parseInt(item['taxi_micro_hcuatro_sin']) * parseInt(adultos));
                        var precioadulto = parseInt(item['taxi_micro_hcuatro_sin']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
                    else if (parseInt(cod) == 4 && parseInt(gu) == 1) {

                        //alert(parseInt(item['taxi_micro_hcuatro_con']) * parseInt(adultos));
                        var precioadulto = parseInt(item['taxi_micro_hcuatro_con']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
                    else if (parseInt(cod) == 8 && parseInt(gu) == 0) {

                        //alert(parseInt(item['transtur_micro_hocho_sin']) * parseInt(adultos));
                        var precioadulto = parseInt(item['transtur_micro_hocho_sin']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
                    else if (parseInt(cod) == 8 && parseInt(gu) == 1) {

                        //alert(parseInt(item['transtur_micro_hocho_con']) * parseInt(adultos));
                        var precioadulto = parseInt(item['transtur_micro_hocho_con']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
                    else if (parseInt(cod) == 12 && parseInt(gu) == 1) {

                        //alert(parseInt(item['transtur_micro_hocho_sin']) * parseInt(adultos));
                        var precioadulto = parseInt(item['transtur_mini_hdoce_con']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
                        ...
                        var precioadulto = parseInt(item['transtur_omnibus_hcuarentatres_con']) * parseInt(adultos);
                        $('#precio_adulto').val(precioadulto);
                    }
            ...
            $.each(inicissss, function (i, item) {
                if (item['id'] == prvinciaa) {
                    ...
                    if (parseInt(codd) == 2 && parseInt(guu) == 0) {
                        ...
                        var precioninnos = parseInt(item['taxi_standar_hdos_sin']) * parseInt(ninnoss);
                        ...
                        var precioninnos = parseInt(item['taxi_standar_hdos_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 4 && parseInt(guu) == 0) {

                        //alert(parseInt(item['taxi_micro_hcuatro_sin']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['taxi_micro_hcuatro_sin']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 4 && parseInt(guu) == 1) {

                        //alert(parseInt(item['taxi_micro_hcuatro_con']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['taxi_micro_hcuatro_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 8 && parseInt(guu) == 0) {

                        //alert(parseInt(item['transtur_micro_hocho_sin']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['transtur_micro_hocho_sin']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 8 && parseInt(guu) == 1) {

                        //alert(parseInt(item['transtur_micro_hocho_con']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['transtur_micro_hocho_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 12 && parseInt(guu) == 1) {

                        //alert(parseInt(item['transtur_micro_hocho_sin']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['transtur_mini_hdoce_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 20 && parseInt(guu) == 1) {

                        //alert(parseInt(item['transtur_micro_hocho_con']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['transtur_mini_hveinte_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 30 && parseInt(guu) == 1) {

                        //alert(parseInt(item['transtur_micro_hocho_con']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['transtur_omnibus_htreinta_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
                    }
                    else if (parseInt(codd) == 43 && parseInt(guu) == 1) {

                        //alert(parseInt(item['transtur_omnibus_hcuarentatres_con']) * parseInt(ninnoss));
                        var precioninnos = parseInt(item['transtur_omnibus_hcuarentatres_con']) * parseInt(ninnoss);
                        $('#precio_ninnos').val(precioninnos)
